...
2.	[Exchange Rate API](https://www.exchangerate-api.com/) to retrieve exchange rates (sign up required).
      
Some important things to consider are:
1.	Error handling:
      - used `try/catch` blocks to handle errors.
2.	Performance
      - used optimization techniques like lazy loading, pure component, etc.
